...
class UserModelAndMappingTest {
    @Test fun `full name and initials ignore missing name parts`() {
    ...
    @Test fun `remote dto maps only required display fields`() {
        val dto = UserDto(7, "Ada", "Lovelace", 36, "ada@example.com", "123", "ada", "image", "admin", CompanyDto("Analytical", "R&D", "Engineer"), AddressDto("1 Main", "London", "England", "UK"))
    ...
    @Test fun `HTTP error UI text preserves status code as formatting argument`() {
